...
export function XIcon({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M18.24 3H21l-6.55 7.49L22.2 21h-6.03l-4.72-6.17L5.98 21H3.2l7.01-8.01L2.4 3h6.18l4.27 5.64L18.24 3Zm-1.06 16.17h1.5L7.9 4.74H6.29l10.89 14.43Z" />
    </svg>
  );
}
...
export function FacebookIcon({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M14.5 21v-7.6h2.55l.38-2.96h-2.93V8.55c0-.86.24-1.44 1.47-1.44h1.57V4.46c-.27-.04-1.2-.12-2.28-.12-2.26 0-3.8 1.38-3.8 3.9v2.2H9v2.96h2.46V21h3.04Z" />
    </svg>
  );
}
